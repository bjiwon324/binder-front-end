  ...
  return (
    <Html lang="ko">
      <Head>
        ...
        <link rel="icon" href={`/images/logo-144.png?ver=${ver}`} />
        ...
        <meta
          property="og:image"
          content={`https://www.bin-finder.net/images/shareLogo.png?ver=${ver}`}
        />
        ...
        <meta
          name="twitter:card"
          content={`https://www.bin-finder.net/images/logo-144.png?ver=${ver}`}
        />
